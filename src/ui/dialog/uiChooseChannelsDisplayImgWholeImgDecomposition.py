...
from src.library.properties.properties import OUTPUT_IMAGE_NAME_RESULT, OUTPUT_IMAGE_WIDTH, OUTPUT_IMAGE_FORMAT, \
    OUTPUT_IMAGE_HEIGHT
...
class UiChooseChannelsDisplayImgWholeImgDecomposition(AbstractDialog):
    ...
    def setupUi(self):
        ...
        self.checkBox_full_img_decomposition = QtWidgets.QCheckBox(self.frameWidget)
        self.checkBox_full_img_decomposition.setGeometry(QtCore.QRect(440, 40, 21, 31))
        self.checkBox_full_img_decomposition.setText("")
        self.checkBox_full_img_decomposition.setObjectName("checkBox_full_img_decomposition")
        
        self.label_full_img_decomposition = QtWidgets.QLabel(self.frameWidget)
        self.label_full_img_decomposition.setGeometry(QtCore.QRect(470, 20, 111, 71))
        self.label_full_img_decomposition.setWordWrap(True)
        self.label_full_img_decomposition.setObjectName("label_full_img_decomposition")
    ...
    def retranslateUi(self):
        ...
        self.label_2_instruction.setText(_translate("self.frameWidget", "Choose channel indexes and Visualization Type"))
        ...
        self.label_full_img_decomposition.setText(_translate("self.frameWidget", "After reverse decomposition"))
    ...
    def set_possible_channels(self):
        ...
        if self.checkBox_full_img_decomposition.isChecked():
        ...
        available_channel_indexes = AvailableActionsApi.find_channels_available_for_action(
                self.data_container, action_type,
    ...
    def on_submit(self):
        ...
        multimodal_image_df_to_image_save_file(self.data_container, OUTPUT_IMAGE_NAME_RESULT,
